...
openssl x509 -req -in agent.csr -CA rootCA.crt -CAkey rootCA.key -CAcreateserial -out agent.crt -days 500 -sha256
...
scp rootCA.crt $REMOTE_NODE1:~/dataclay-class/dockers/traefik/cert
popd
