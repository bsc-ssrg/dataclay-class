...
ssh $REMOTE_NODE "cd ~/dataclay-class/examples/CLASSDemo/demo/python3_remote; mv dockers/env/LM.environment.orig dockers/env/LM.environment"
ssh $REMOTE_NODE "cd ~/dataclay-class/examples/CLASSDemo/demo/python3_remote; mv dockers/env/DS.environment.orig dockers/env/DS.environment"
...
ssh $REMOTE_NODE "cd ~/dataclay-class/examples/CLASSDemo/demo/python3_remote; cp dockers/env/LM.environment dockers/env/LM.environment.orig; sed -i \"s/logicmodule1/${REMOTE_IP}/g\" dockers/env/LM.environment"
ssh $REMOTE_NODE "cd ~/dataclay-class/examples/CLASSDemo/demo/python3_remote; cp dockers/env/DS.environment dockers/env/DS.environment.orig; sed -i \"s/ds1java1/${REMOTE_IP}/g\" dockers/env/DS.environment"
...
ssh $REMOTE_NODE "cd ~/dataclay-class/examples/CLASSDemo/demo/python3_remote; bash stopDataClaysAndClean.sh $REMOTE_DOCKER" # stop dataClay in remote node 
ssh $REMOTE_NODE "cd ~/dataclay-class/examples/CLASSDemo/demo/python3_remote; bash startDataClay.sh $REMOTE_DOCKER" # start dataClay in remote node 
